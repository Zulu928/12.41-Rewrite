...
public:
	...
	class UFortPlayerControllerAthenaXPComponent* ParentComp;
	class UFortPlayerControllerAthenaXPComponent* XPComponent;
	class UFortPlayerControllerAthenaXPComponent* MatchXp;// 0x118(0x8)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};

class UFortPlayerControllerAthenaXPComponent : public UActorComponent //UFortControllerComponent
{
public:
	TArray<struct FAthenaAccolades>              PlayerAccolades;                                   // 0xB0(0x10)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	TArray<struct FCardSlotMedalData>            LocalPunchCardMedals;                              // 0xC0(0x10)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_3C93[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FXPEventArray                         EventArray;                                        // 0xE8(0x120)(Net, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TArray<struct FXPEventEntry>                 WaitingQuestXp;                                    // 0x208(0x10)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	int32                                        RestXP;                                            // 0x218(0x4)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                         bRegisteredWithQuestManager;                       // 0x21C(0x1)(Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_3C94[0xDB];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FAthenaLevelInfo                      CachedLevelInfo;                                   // 0x2F8(0x24)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_3C95[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UAthenaSeasonItemDefinition* CachedSeasonDef;                                   // 0x320(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                        CachedSeasonMatchXpBoost;                          // 0x328(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_3C96[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	int32                                        CurrentLevel;                                      // 0x330(0x4)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                        PlayerXp;                                          // 0x334(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                        TotalXpEarned;                                     // 0x338(0x4)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                        MedalBonusXP;                                      // 0x33C(0x4)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                        SurvivalXp;                                        // 0x340(0x4)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                        CombatXp;                                          // 0x344(0x4)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                        MatchXp;                                           // 0x348(0x4)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                        ChallengeXp;                                       // 0x34C(0x4)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int64                                        HasBRMatchReportCompletedProfileVer;               // 0x350(0x8)(Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int64                                        InMatchProfileVer;                                 // 0x358(0x8)(Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UFortAccoladeItemDefinition*>   MedalsEarned;                                      // 0x360(0x10)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	TArray<TWeakObjectPtr<class UFortQuestItem>> QuestsUpdated;
...
public:
	...
	void OnXpEvent1(FXPEventInfo& XPEvent)
	{
	...
	void OnXPEvent2(FXPEventInfo& XPEvent)
	{
		static auto fn = FindObject<UFunction>("/Script/FortniteGame.FortPlayerControllerAthenaXPComponent.OnXPEvent");
		this->ProcessEvent(fn, &XPEvent);
	}
