...
DWORD WINAPI Main(LPVOID)
{
    ...
    LOG_INFO(LogInit, "Initializing 12.41!");
    ...
    {
        MessageBoxA(0, "Please undefine ABOVE_S20", "12.41", MB_ICONERROR);
        return 0;
    }
#else
    if (Fortnite_Version > 20)
    {
        MessageBoxA(0, "Please define ABOVE_S20", "12.41", MB_ICONERROR);
        return 0;
    }
#endif
    ...
    */
...

    {
        ...
        MemberOffsets::FortPlayerStateAthena::ChestsSearched = FindOffsetStruct("/Script/FortniteGame.FortPlayerStateAthena", "NumChestsOpened", false);
